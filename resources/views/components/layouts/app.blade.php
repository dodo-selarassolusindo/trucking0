        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
                <div class="container">
                    ...
                    <a href="/armada" wire:navigate class="navbar-brand">ARMADA</a>
                    <a href="/tperbaikan" wire:navigate class="navbar-brand">TRANSAKSI PERBAIKAN</a>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0" role="search">
                            <a href="https://sanjayatrans.com" target="_blank" class="btn btn-success">SANJAYATRANS.COM</a>
                        </ul>
                    </div>
                </div>
            </nav>
